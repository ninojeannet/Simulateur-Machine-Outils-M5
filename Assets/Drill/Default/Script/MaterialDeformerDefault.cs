...
namespace Simulation
{
    ...
    /// </summary>
    public class MaterialDeformerDefault : MonoBehaviour
    {
        /// <summary>
        ...
        {
            CapsuleCollider colliderOfDrill = GetComponent<CapsuleCollider>();
            Vector3 centerOfDrill = transform.position;
            Vector3 topOfDrill = new Vector3(transform.position.x, transform.position.y + colliderOfDrill.height - colliderOfDrill.radius, transform.position.z);
            Vector3 bottomOfDrill = new Vector3(transform.position.x, transform.position.y - colliderOfDrill.height - colliderOfDrill.radius, transform.position.z);
            if (!Physics.CheckCapsule(topOfDrill, bottomOfDrill, colliderOfDrill.radius)) { return; }
