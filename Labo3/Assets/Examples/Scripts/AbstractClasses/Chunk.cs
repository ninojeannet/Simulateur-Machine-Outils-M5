...
namespace MarchingCubes.Examples
{
    ...
    public abstract class Chunk : MonoBehaviour
    {
        ...
        private Material machinedmaterial;
        ...
        public void Initialize(int chunkSize, float isolevel, int3 coordinate, Material material,Material machinedmaterial)
        {
            _isolevel = isolevel;
            ...
            this.machinedmaterial = machinedmaterial;
        ...
        private void CompleteMeshGeneration()
        {
            ...
            //renderer.material = machinedmaterial;
